    ...
    return (
        <>
            ...
            <div className="max-w-[1100px] mx-auto p-4 ">
                ...
                <p className="mt-2 mb-[40px]">Thank you for visiting Our Website. By using our website, you agree to comply with and be bound by the following disclaimer. If you do not agree with any part of this disclaimer, please do not use our website.</p>

                <h2 className="text-3xl font-bold mb-6">1. Content Accuracy</h2>
                ...
                <h2 className="text-3xl font-bold mb-6">2. External Links</h2>
                ...
                <h2 className="text-3xl font-bold mb-6">3. Changes to the Website</h2>
                ...
                <h2 className="text-3xl font-bold mb-6">4. No Professional Advice</h2>
                ...
                <h2 className="text-3xl font-bold mb-6">6. Changes to the Disclaimer</h2>
                ...
                <h2 className="text-3xl font-bold mb-6">7. Contact Information</h2>
