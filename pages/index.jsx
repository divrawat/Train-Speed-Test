          ...
          <article>
            <div className="max-w-[1200px] mx-auto p-3 rounded-lg  opacity-90" >
              ...
              <div className="flex justify-center items-center mt-8">
                <button onClick={calculate} className="flex items-center border border-gray-300 bg-black text-white px-4 py-2 tracking-wider font-bold rounded-md transition duration-300 ease-in-out hover:bg-[#2b2a2b] hover:text-gray-300">
