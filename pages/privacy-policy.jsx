    ...
    return (
        <>
            ...
            <div className="max-w-[1100px] mx-auto p-4 ">
                ...
                <p className="mt-2 mb-[40px]">Thanks you for visiting our website. This Privacy Policy is designed to help you understand how we collect, use, disclose, and safeguard your personal information when you visit our website or use our services through Google AdSense. By accessing or using our website, you consent to the practices described in this Privacy Policy.</p>
                ...
                <h2 className="text-3xl font-bold mb-6">Google AdSense</h2>
                ...
                <h2 className="text-3xl font-bold mb-6">Your Choices</h2>
